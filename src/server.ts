...
app.use(function (req, res, next) {
  if (
    ...
    !req.headers.authorization.includes(PersonalAccessToken)
  ) {
...
app.delete(
  "/v4/linode/instances/:linodeId/configs/:configId",
  (req, res) => {}
);
...
// Disk Clone
app.post(
  "/v4/linode/instances/:linodeId/disks/:diskId/clone",
  (req, res) => {}
);

// Disk Root Password Reset
app.post(
  "/v4/linode/instances/:linodeId/disks/:diskId/password",
  (req, res) => {}
);

// Disk Resize
app.post(
  "/v4/linode/instances/:linodeId/disks/:diskId/resize",
  (req, res) => {}
);
